...
1. Click hızını ayarla (1-10000 CPS)
2. Click türünü seç (👆 Sol / 👉 Sağ)
3. Hedef belirle (0 = sınırsız)
4. ▶️ **BAŞLAT** butonuna tıkla veya kısayol tuşuna bas

### ⌨️ Kısayol Tuşu Ayarlama

1. 🎯 **Kısayol Tuşu** bölümündeki butona tıkla
2. **"Tuşa basın..."** mesajını bekle
3. İstediğin klavye veya mouse tuşuna bas
4. **Kombinasyon örneği:** Ctrl tuşuna bas → sonra F5'e bas
5. Artık o tuş kombinasyonuyla başlat/durdur yapabilirsin
...
1. **Fork** et bu repository'yi
2. **Feature branch** oluştur (`git checkout -b feature/HarikalOzellik`)
3. Değişikliklerini **commit** et (`git commit -m 'Harika özellik eklendi'`)
4. Branch'ini **push** et (`git push origin feature/HarikalOzellik`)
5. **Pull Request** aç
...
[![GitHub](https://img.shields.io/badge/GitHub-OmerUzunsoy-181717?style=for-the-badge&logo=github)](https://github.com/OmerUzunsoy)
[![Email](https://img.shields.io/badge/İletişim-GitHub_Issues-blue?style=for-the-badge&logo=github)](https://github.com/OmerUzunsoy/UzunsClicker-V2/issues)
...
![GitHub stars](https://img.shields.io/github/stars/OmerUzunsoy/UzunsClicker-V2?style=social)
![GitHub forks](https://img.shields.io/github/forks/OmerUzunsoy/UzunsClicker-V2?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/OmerUzunsoy/UzunsClicker-V2?style=social)

<img src="https://komarev.com/ghpvc/?username=UzunsClicker-V2&label=Görüntülenme&color=0e75b6&style=flat" alt="Profile views" />
